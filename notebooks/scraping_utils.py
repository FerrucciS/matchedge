...
def get_tournament(driver, tourn_archive_url, save_cache=False):
    """
...
def extract_results_url(df_tournament: pd.DataFrame, url_col="url", date_col="end_date"):
    """
    ...
    for i, row in df_tournament.iterrows():                                                     # Iterate through each row
        ...
        # --- 1.0 Make Results URLs for 1 YTD --- 
